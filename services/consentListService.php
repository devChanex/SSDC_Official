...
class ServiceClass
{
    ...
    public function loadTreatmentList()
    {
        ...
        $query = "select b.*,concat(b.lname,', ',b.fname, ' ', b.mdname) as fullname,a.id,a.dentist,a.date from consent a inner joinclientprofileb on a.clientid=b.clientid where status='Active'";
