...
$result = $service->bookappointmentinfo($clientid);
echo $result;
...
class ServiceClass
{
	...
	public function bookappointmentinfo($clientid)
	{
		//:a,:b parameter
		try{

		$query = "update bookappointmentinfo set status='Declined' where clientid=:b";
