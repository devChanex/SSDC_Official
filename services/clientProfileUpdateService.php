...
$result = $service->updatePatientProfile($clientId,$lastName,$firstName,$middleName,$nickName,$age,$gender,$birthday,$homeAddress,$occupation,$contactNumber,$guardianName,$guardianOccupation,$referredBy);
echo $result;
...
class ServiceClass
{
	...
	public function updatePatientProfile($clientId,$lastName,$firstName,$middleName,$nickName,$age,$gender,$birthday,$homeAddress,$occupation,$contactNumber,$guardianName,$guardianOccupation,$referredBy)
	{
		//:a,:b parameter
		try{

		$query = "update clientProfile set lname=:a,fname=:b,mdname=:c,nickname=:d,age=:e,sex=:f,occupation=:g,birthDate=:h,mobileNumber=:i,homeAddress=:j,guardianName=:k,gOccupation=:l,refferedBy=:m where clientid=:n";
