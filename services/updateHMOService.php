...
$result = $service->process($id, $name, $accountnumber, $birthdate, $company, $contact, $hmo, $validity, $benefit, $remarks, $verification, $agent, $hmotype, $approvalCode, $calledby);
echo $result;
class ServiceClass
{
    ...
    public function process($id, $name, $accountnumber, $birthdate, $company, $contact, $hmo, $validity, $benefit, $remarks, $verification, $agent, $hmotype, $approvalCode, $calledby)
    {

        try {

            $query = "update hmo set calledby=:o,approvalcode=:n,hmotype=:m,verificationStatus=:k,agent=:l,accountnumber=:a, hmo=:b, name=:c, dob=:d, company=:e, contact=:f,validity=:h,dentalbenefits=:i,remarks=:j where id=:g";
