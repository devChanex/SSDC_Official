                ...
                <div class="container-fluid" id="content-table">
                    ...
                    <div class="card shadow mb-12">
                        ...
                        <div class="row float-right"  style-"float: right;">
                            ...
                            <input type="button" class="btn btn-primary" onclick="printDiv('daterange')" value="Print">
                            
</div>
                            <h6 class="m-0 font-weight-bold text-primary">RECORDS OF SOA AS OF: <?php $dToday=date('Y-m-d'); echo $dToday;   ?></h6> 
