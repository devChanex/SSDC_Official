...
$result = $service->addPatientProfile($lastName, $firstName, $middleName, $nickName, $age, $gender, $birthday, $homeAddress, $occupation, $contactNumber, $guardianName, $guardianOccupation, $referredBy, $religion, $civilStatus, $imageData, $hmo, $cardNumber, $company, $emailAddress);
echo $result;
...
class ServiceClass
{
	...
	public function addPatientProfile($lastName, $firstName, $middleName, $nickName, $age, $gender, $birthday, $homeAddress, $occupation, $contactNumber, $guardianName, $guardianOccupation, $referredBy, $religion, $civilStatus, $imageData, $hmo, $cardNumber, $company, $emailAddress)
	{
		//:a,:b parameter
		try {

			$query = "Insert into clientprofile (lname,fname,mdname,nickname,age,sex,occupation,birthDate,mobileNumber,homeAddress,guardianName,gOccupation,refferedBy,religion,civilstatus,photo,hmo,cardnumber,company,emailAddress) values (:a,:b,:c,:d,:e,:f,:g,:h,:i,:j,:k,:l,:m,:n,:o,:p,:q,:r,:s,:t)";
