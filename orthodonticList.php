...
<head>
    ...
    <title>SSDC - Client Profile List</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid" id="content-table">
                    ...
                    <div class="card shadow mb-12">
                        <div class="card-header py-3 d-flex justify-content-between <?php echo $cards; ?>">
                            <h6 class="m-0 font-weight-bold">Orthodontic Patient List</h6>
            ...
            <script src="controllers/orthodonticListController.js"></script>
