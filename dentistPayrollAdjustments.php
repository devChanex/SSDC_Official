...
<head>
    ...
    <title>SSDC - Expenses List</title>
                                ...
                                <table class="table table-bordered text-dark" id="sortableTable" width="100%"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick="sortTable(this)">Dentist <span class="sort-icon"></span></th>
                                            <th onclick="sortTable(this)">Particular <span class="sort-icon"></span>
                                            </th>
                                            <th onclick="sortTable(this)">Type <span class="sort-icon"></span>
                                            </th>
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-content">
                                <div class="modal-header <?php echo $cards; ?>">
                                    <h5 class="modal-title" id="editExpenseModalLabel">Payroll Adjustment</h5>
                                ...
                                <div class="modal-body">
                                    <form id="editExpenseForm">
                                        <input type="hidden" name="padjid" id="modal-padjid">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="dentist" id="modal-dentist" class="form-control">
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <label>Type</label>
                                            <select class="form-control" name="type" id="modal-type">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="deleteExpenseForm">
                                        <input type="hidden" name="expenseid" id="modal-deleteid">
