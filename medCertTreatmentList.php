...
<head>
    ...
    <title>SSDC - DentalCert Treatment List</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container-fluid" id="content-table" style="padding-left:20%;padding-right:20%;">
                    ...
                    <div class="card shadow mb-12">
                        <div class="card-header py-3 <?php echo $cards; ?>">
                            <strong>DentalCert Treatment List</strong>
                            ...
                            <div class="modal fade" id="editTreatmentModal" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form>
                                            <div class="card-header py-3 <?php echo $cards; ?>">
                                                <h5 class="modal-title">Add Treatment for Dental Cert</h5>
            ...
            <script src="controllers/getMedCertTreatmentListController-v2.js"></script>
